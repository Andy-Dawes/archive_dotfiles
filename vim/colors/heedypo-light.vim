...
if &background == "light"
    ...
    hi Cursor gui=standout guifg=#009194 guibg=NONE
    ...
    hi DiffAdd gui=NONE guifg=NONE guibg=#ccffd5
    hi DiffChange gui=NONE guifg=NONE guibg=#e7ecc1
    hi DiffDelete gui=NONE guifg=NONE guibg=#ffcccf
    ...
    hi ErrorMsg gui=NONE guifg=#ed720c guibg=#ededed
    ...
    hi Normal gui=NONE guifg=#351c2c guibg=#ededed
    hi Number gui=NONE guifg=#707070 guibg=NONE
    hi Pmenu gui=NONE guifg=#56505e guibg=#f9f9fb
    hi PmenuSbar gui=NONE guifg=NONE guibg=#ededed
    hi PmenuSel gui=NONE guifg=#5e3c86 guibg=#e3e3e3
    ...
    hi Special gui=NONE guifg=#c43a08 guibg=NONE
    hi SpecialKey gui=NONE guifg=#c2c2c2 guibg=NONE
    hi SpellBad gui=underline guifg=#9d0b06 guibg=#ebebeb
    ...
    hi Statement gui=NONE guifg=#903d94 guibg=NONE
    hi StatusLine gui=NONE guifg=#262626 guibg=#ededed
    hi StatusLineNC gui=NONE guifg=#969696 guibg=#ededed
    hi StorageClass gui=NONE guifg=#009194 guibg=NONE
    hi String gui=NONE guifg=#212121 guibg=NONE
    ...
    hi Todo gui=bold guifg=#941100 guibg=NONE
    hi Type gui=NONE guifg=#426c94 guibg=NONE
    hi Underlined gui=NONE guifg=NONE guibg=NONE
    hi VertSplit gui=NONE guifg=#e3e3e3 guibg=NONE
    hi Visual gui=NONE guifg=NONE guibg=#e3e3e3
    hi VisualNOS gui=NONE guifg=NONE guibg=NONE
    hi WarningMsg gui=NONE guifg=#9f2a28 guibg=#ededed
...
elseif &background == "dark"
    ...
    hi Normal gui=NONE guifg=#b0b0b0 guibg=#dbdbdb
